...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#barplot(A,main="OVERALL DEATH PER AGE",xlab="AGE",ylab="FREQUENCY")}
...
\FunctionTok{hist}\NormalTok{(death\_all}\SpecialCharTok{$}\NormalTok{age, }\AttributeTok{col=}\StringTok{\textquotesingle{}maroon\textquotesingle{}}\NormalTok{,}\AttributeTok{main=}\StringTok{\textquotesingle{}Deaths Female Covid Effecties w.r.t Age\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Covid19_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\FunctionTok{hist}\NormalTok{(mendeath}\SpecialCharTok{$}\NormalTok{age, }\AttributeTok{col=}\StringTok{\textquotesingle{}brown\textquotesingle{}}\NormalTok{,}\AttributeTok{main=}\StringTok{\textquotesingle{}Deaths of Male Covid Effecties w.r.t Age\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Covid19_files/figure-latex/unnamed-chunk-4-1.pdf}
Comment:
...
\FunctionTok{hist}\NormalTok{(womendeath}\SpecialCharTok{$}\NormalTok{age, }\AttributeTok{col=}\StringTok{\textquotesingle{}light blue\textquotesingle{}}\NormalTok{,}\AttributeTok{main=}\StringTok{\textquotesingle{}Deaths of Female Covid Effecties w.r.t Age\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{hist}\NormalTok{(data\_copied}\SpecialCharTok{$}\NormalTok{age,data\_copied}\SpecialCharTok{$}\NormalTok{death\_dummy)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Covid19_files/figure-latex/unnamed-chunk-8-1.pdf}
